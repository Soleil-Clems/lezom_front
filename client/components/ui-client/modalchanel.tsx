    ...
    <DialogContent className="bg-[#313338] text-[#dbdee1] border-none sm:max-w-md">
      <form onSubmit={handleSubmit}>
        <DialogHeader>
          ...
          <DialogDescription className="text-[#b5bac1]">{t('createChannelDesc')}</DialogDescription>
        </DialogHeader>

        <div className="space-y-4 py-4">
          <div className="space-y-2">
            <Label htmlFor="name" className="text-xs font-bold uppercase text-[#b5bac1]">
              {t('channelName')}
            </Label>
            <Input
              id="name"
          ...
          <div className="space-y-2">
            <Label htmlFor="type_chanel" className="text-xs font-bold uppercase text-[#b5bac1]">
              {t('channelType')}
            </Label>
            <select
              id="type_chanel"
