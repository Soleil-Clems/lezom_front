                        ...
                        <Tooltip delayDuration={0}>
                            <TooltipTrigger asChild>
                                <button className="group flex items-center gap-3 w-full outline-none">
                                    <div
                                        className="flex h-12 w-12 shrink-0 items-center justify-center rounded-[24px] bg-[#313338] text-green-500 transition-all duration-200 hover:rounded-[16px] hover:bg-green-500 hover:text-white">
                                        <Plus size={25}/>
                                    </div>
                        ...
                        <SidebarMenuItem>
                            <SidebarMenuButton asChild className="h-12 w-full md:w-12 p-0 hover:bg-transparent">
                                <a href="/profil" className="group flex items-center gap-3 w-full md:justify-center">
                                    <div
                                        className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-indigo-500 text-white transition-all duration-200 hover:rounded-[16px]">
                                        <User size={24}/>
                                    </div>
                                </a>
                            </SidebarMenuButton>
