...
export function ServerSidebar() {
    ...
    return (
        <TooltipProvider>
            <Sidebar collapsible="offcanvas" className="w-20 border-r-0 bg-[#1E1F22]">
                        ...
                        <Dialog>
                            <Tooltip delayDuration={0}>
                                <DialogTrigger asChild>
                                    <TooltipTrigger asChild>
                                        <button className="group flex h-12 w-12 shrink-0 items-center justify-center rounded-[24px] bg-[#313338] text-green-500 transition-all duration-200 hover:rounded-[16px] hover:bg-green-500 hover:text-white outline-none">
                                            <Plus size={25} />
                                        </button>
                                    </TooltipTrigger>
                                </DialogTrigger>
                ...
                <SidebarFooter className="py-4 flex flex-col items-center justify-center">
                    <SidebarMenu>
                        <SidebarMenuItem>
                            <SidebarMenuButton asChild className="h-12 w-12 p-0 hover:bg-transparent">
                                <a href="/profil" className="flex items-center justify-center">
