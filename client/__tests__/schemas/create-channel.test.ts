...
describe('createChannelSchema', () => {
  it('valide les données minimales', () => {
    expect(() => createChannelSchema.parse({ name: 'general', type: 'text', serverId: 1 })).not.toThrow()
  })

  it('valide type call', () => {
    expect(() => createChannelSchema.parse({ name: 'voice', type: 'call', serverId: 2 })).not.toThrow()
  })
